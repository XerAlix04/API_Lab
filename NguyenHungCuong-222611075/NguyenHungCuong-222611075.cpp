// NguyenHungCuong-222611075.cpp : Defines the entry point for the application.
//

#include "framework.h"
#include "NguyenHungCuong-222611075.h"
                     ...
                     _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_NGUYENHUNGCUONG222611075, szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_NGUYENHUNGCUONG222611075));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon          = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_NGUYENHUNGCUONG222611075));
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_RBUTTONDOWN:
        ...
        TrackPopupMenu(menuNen, TPM_RIGHTBUTTON, pointR.x, pointR.y, 0, hWnd, NULL);
        break;
    case WM_CLOSE:
        {
